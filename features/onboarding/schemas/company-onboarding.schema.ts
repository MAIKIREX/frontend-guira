...
const nonNegativeNumericString = (requiredMessage: string, invalidMessage: string) =>
  z
    .string()
    .trim()
...
export const companyOnboardingSchema = z.object({
  ...
  estimated_monthly_volume: nonNegativeNumericString('Requerido', 'El volumen estimado no puede ser negativo.'),
