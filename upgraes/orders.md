...
Modificar la acción **“Orders** de cada registro de Orders para que **redirija a una nueva vista de detalle** donde el administrador o staff pueda revisar toda la información relacionada con la transacción y la verificación del usuario.
...
La ventana debe contener las siguientes datos

    Informacion de la orden
    los documentos cargados por el usuario
    los documentos cargados por el staff
    tambien para que tenga logica y sincronice con las acciones del cliente este se tiene que actualiza depende a los estados es decir si el cliente envia una orden y el staff la aprueba el estado de la orden debe cambiar a aprobado y asi sucesivamente

    para ello tambien guiate en como es el flujo de 
